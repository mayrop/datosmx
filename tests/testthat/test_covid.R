...
# need to add https://cran.r-project.org/web/packages/httptest/vignettes/httptest.html
...
test_that("running daily cases without date fails", {
  expect_error(get_covid_cases("10-10-2020"), "Date was provided in invalid format, try: YYYY-MM-DD")
  expect_error(get_covid_cases("2020-04-10"), "File is not available for: 2020-04-10 open")
})
